...
// url video de Romero, Nadia: https://youtu.be/C6LQoCL3eis?si=9GxaoJr4Wd7Ayorv
...
function preload() {
  ...
  // placeholders (me da miedo borrar esto)
  ...
  // png del gigante y trineo (juego)
...
class Trineo {
  ...
  chocaCon(gigante) {
    ...
    let margen = 5;
    if (this.x + this.ancho/2 - margen > gigante.x - gigante.ancho/2 &&
      this.x - this.ancho/2 + margen < gigante.x + gigante.ancho/2 &&
      this.y + this.alto/2 - margen > gigante.y - gigante.alto/2 &&
      this.y - this.alto/2 + margen < gigante.y + gigante.alto/2) {
      return true;
    }
    return false;
